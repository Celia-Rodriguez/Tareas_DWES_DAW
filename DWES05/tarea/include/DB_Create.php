...
try{
    ...
    //borramos la base de datos para volver a crearla, en este ejercicio es posible hacerlo ya que la base de datos no cambia su información durante el desarrollo del ejercicio
